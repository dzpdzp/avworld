...
*/
$baseUrl = 'https://www.e-metals.net/datafile/user_upload_file/';
...
$config['AccessControl'][] = Array(
		'role' => '*',
		'resourceType' => 'ExcelHtmlFiles',
		'folder' => '/ExcelHtmlFiles',
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'htm,html,7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
		'deniedExtensions' => '');

$config['ResourceType'][] = Array(
		'name' => 'ExcelHtmlFiles',				// Single quotes not allowed
		'url' => $baseUrl . 'ExcelHtmlFiles',
		'directory' => $baseDir . 'ExcelHtmlFiles',
		'maxSize' => 0,
		'allowedExtensions' => 'htm,html,gif,jpeg,jpg,,png,zip',
		'deniedExtensions' => '');
